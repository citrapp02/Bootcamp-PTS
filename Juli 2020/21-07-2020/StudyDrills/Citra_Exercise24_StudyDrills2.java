public class Citra_Exercise24_StudyDrills2 {
    public static void main(String[] args ){
        int a, b, c, d;
        double r, rps;

        rps = Math.random();
        if ( rps < 0.3333333 ) { //will be tru 1/3 of the time
            System.out.println( "Rock");
        }
        else if ( rps < 0.6666667 ) { //will be tru 1/3 of the time
        ...
        //pick four random integer, each 1-100
        a = 1 + (int)( 100*Math.random() );
        ...
        //pick four random integer, each 1-99
        ...
        //pick four random integer, each 10-20
        ...
        System.out.println( "0-10:\t"+(1+(int)r));
